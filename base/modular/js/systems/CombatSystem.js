...
import {
    PLAYER_RADIUS, PLAYER_MAX_HP, PLAYER_BASE_ATTACK, SWORD_ATTACK_BONUS,
    ATTACK_COOLDOWN, ATTACK_RANGE, ATTACK_ARC, SUN_RADIUS, SUN_DAMAGE_RADIUS,
    SUN_DAMAGE_MIN, SUN_DAMAGE_MAX, SUN_DAMAGE_TICK, PLANET_HEAT_TEMP_THRESHOLD,
    PLANET_HEAT_RANGE, PLANET_HEAT_DAMAGE, PLANET_HEAT_TICK, CREATURE_CONTACT_DAMAGE,
    CREATURE_CONTACT_COOLDOWN, CREATURE_AGGRO_DURATION, RESPAWN_INVINCIBILITY,
    STAT_BOOST_PICKUP_RANGE, STAT_BOOST_BOB_SPEED, STAT_BOOST_BOB_HEIGHT,
    STAT_BOOST_SPIN_SPEED, ESSENCE_ATTACK_CAP_MULT, ESSENCE_MAX_HP_CAP_MULT,
    PLAYER_SPEED_BOOST_CAP, CREATURE_ESSENCE_MAP, ATTACK_SWING_DURATION
} from '../constants.js';
...
export default class CombatSystem {
    ...
    damagePlayerFromBreach(amount, ctx, sourcePos = null) {
        this._damagePlayer(amount, ctx, sourcePos);
    }
